...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println('a' + 'b'); //a:97, b::98 *\(ascii code)
        ...
        //컴퓨터는 문자를 인식하지 못하고 숫자로만 인식할수 있기 때문에,
        //모든 문자에 대응하는 숫자들이 매칭이 되어 있다(아스키코드와 유니코드)
        ...
        //3.문자열의 연산
        //3-1. 문자열과 문자열의 '+' 연산 결과는 문자열 합치기(이어 붙이기)가 된다.
        ...
        //문자열과의 연산은 '+' 연산만 가능하다.
        //연산결과는 다른 형태의 값들도 문자열로 취급하여 문자열 이어붙이기(문자열 합치기)
